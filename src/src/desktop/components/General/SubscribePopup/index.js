...
import './SubscribePopup.css'; // Your CSS file for styling
...
const SubscribePopup = () => {
  ...
  return isPopupVisible ? (
    <div className="popup-subscribe-main">
      {/* Updated welcome message with gradient color and different text sizes */}
      <div className="popup-welcome-div">
        <div className="popup-welcome-text">Welcome to</div>
        <div className="popup-company-text">Imaggar</div>
      </div>
      {/* Existing content */}
      <div className="popup-content">
        ...
        <div className="additional-content">
          <p>More information about Imaggar and our services...</p>
        </div>
      </div>
    </div>
  ) : null;
