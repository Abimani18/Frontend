        ...
        <div className="card mb-3 shadow p-4 mb-5 bg-body-tertiary rounded-4" style={{maxWidth: "500px",height:"300px"}}>
          <div className="row g-0">
            <div className="col-md-6">
              <img src="https://tse4.mm.bing.net/th?id=OIP.IVnbdHO7M1MZLaikgIOoGAHaHa&pid=Api&P=0&h=180" className="img-fluid rounded-start w-100 " style={{height:"250px"}}  alt="..." />
            </div>
            <div className="col-md-6">
              <div className="card-body">
                <h5 className="card-title">Chatbot Integrator</h5>
